                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
						   ...
						   <h4 class="box_title_link"><a class="btn btn-info"  href="add_leave.php">Add Leave</a> </h4>
						   <?php } ?>
                        </div>
                        <div class="card-body--">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <td>
									     <?php
									      if($row['leave_status']==1){ ?>
									      <a class="btn btn-danger"  href="leave.php?id=<?= $row['id']?>&type=delete">Delete</a>
									     <?php } ?>
									   </td>
